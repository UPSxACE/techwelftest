const gb = {
  ...
  ScreenshotDesc3:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  ScreenshotTitle4: 'Screenshot Title 4',
  ScreenshotDesc4:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  Login: 'Login',
  Register: 'Register',
  string_empty: 'This field cannot be empty.',
  string_email: 'Please insert a valid email.',
  formExample: 'Example: ',
  submit: 'Submit',
  CompanyName: 'Company Name',
  EmailAddress: 'Email Address',
  account_already: 'Sign in instead',
  err_string_min:
    'This field must be filled with a value of at least {{size}} characters.',
  err_number_base: 'This field only accepts numbers.',
  does_not_match_password: 'The passwords do not match.',
  image_too_big: 'The image cannot be bigger than {{limitW}}x{{limitH}} px.',
